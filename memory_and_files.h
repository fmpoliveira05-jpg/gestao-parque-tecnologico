 ...
 * This function is also responsible for allocating memory for equipment and maintenance when necessary,
 ...
 *
 * This function is used to double the memory for maintenance whenever necessary.
 *
 * @param equipment A pointer to struct: EquipmentList.
 */
